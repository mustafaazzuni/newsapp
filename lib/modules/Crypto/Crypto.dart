...
class CryptoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (BuildContext context) => NewsCubit()..getCrypto(),
        child: BlocConsumer<NewsCubit, NewsStates>(
            ...
            builder: (context, state) {
              ...
              return  SmartRefresher(
                ...
                onLoading: cubit.RefreshCrypto,
                enablePullDown: false,
                enablePullUp: true,
                // return null;
                child: ListView.builder(
                  itemCount: cubit.Crypto.length ,
                  itemBuilder: (context, index) {


                    final Photo photo = cubit.Crypto[index];
                    return Card(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                      Share.share(
                                        'check out this news ' +
                                          cubit.Crypto[index].link,
                                    subject: cubit.Crypto[index].title);
                                  },
                                ),
                              ]),
                          /* IconButton(
