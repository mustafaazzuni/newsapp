...
class TelecomScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (BuildContext context) => NewsCubit()..getTelecom(),
        child: BlocConsumer<NewsCubit, NewsStates>(
            ...
            builder: (context, state) {
              ...
              return  SmartRefresher(
                ...
                onLoading: cubit.RefreshTelecom,

                // return null;
                child: ListView.builder(
                  itemCount: cubit.Telecom.length ,
                  itemBuilder: (context, index) {


                    final Photo photo = cubit.Telecom[index];
                    return Card(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                     Share.share(
                                       'check out this news ' +
                                         cubit.Telecom[index].link,
                                   subject: cubit.Telecom[index].title);
                                  },
                                ),
                              ]),
                          /* IconButton(
