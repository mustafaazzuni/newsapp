...
class PoliticsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (BuildContext context) => NewsCubit()..initDb()..getPolitics() ,
      child: BlocConsumer<NewsCubit, NewsStates>(
          ...
          builder: (context, state) {
            ...
            return SmartRefresher(
              ...
              onLoading: cubit.RefreshPolitics,

              // return null;
              child: ListView.builder(
                itemCount: cubit.Politics.length ,
                itemBuilder: (context, index) {
                  var cubit = NewsCubit.get(context);

                  final Photo photo = cubit.Politics[index];
                  return Card(
                        ...
                        Row(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  cubit.insertArt(
                                      id: cubit.Politics[index].newsid,
                                      imagePath:
                                      cubit.Politics[index].picture,
                                      newsTitle:
                                      cubit.Politics[index].title,
                                      link: cubit.Politics[index].link);
                                },
                              ),
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                   Share.share(
                                     'check out this news ' +
                                       cubit.Politics[index].link,
                                 subject: cubit.Politics[index].title);
                                },
                              ),
                            ]),
                        /* IconButton(
