...
class EnergyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  BlocProvider(
        create: (BuildContext context) => NewsCubit()..getEnergy(),
        child: BlocConsumer<NewsCubit, NewsStates>(
            ...
            builder: (context, state) {
              ...
              return  SmartRefresher(
                ...
                onLoading: cubit.RefreshEnergy,
                enablePullUp: true,
                enablePullDown: false,

                // return null;
                child: ListView.builder(
                  itemCount: cubit.Energy.length ,
                  itemBuilder: (context, index) {


                    final Photo photo = cubit.Energy[index];
                    return Card(
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                     Share.share(
                                       'check out this news ' +
                                         cubit.Energy[index].link,
                                   subject: cubit.Energy[index].title);
                                  },
                                ),
                              ]),
                          /* IconButton(
                       ...
                       /* onPressed: () async{
                          ...
                          if (index % 5 == 0)
                            Container(
                              ...
                              child: NativeInlinePage(),                  //  _bannerAd()
                              // NativeAdmob(
                              //   // Your ad unit id
                              //   adUnitID: _adUnitID,
